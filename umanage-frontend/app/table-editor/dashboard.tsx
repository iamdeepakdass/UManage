...
const navigation = [
  { name: 'Table Editor', href: '#', icon: HomeIcon, current: true },
]
...
export default function Dashboard() {
  ...
  useEffect(() => {
    (async() => {
        ...
        const {data} : any = await axios.get("http://localhost:8000/getTableNames");
        setListOfTables(data.map((tableName: string, index: number) => { return getTableStructre(tableName, index) }));
    })()
  }, [])  
      ...
      */}
      <div>
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6 pb-2">
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                          <div className="text-xs font-semibold leading-6 text-indigo-200">Your tables</div>
        ...
        <main className="py-10 lg:pl-72">
          <div className="px-4 sm:px-6 lg:px-8">{selectedTable !== "" ? <Table tableName = {selectedTable}/> : null}</div>
        </main>
      </div>
    </>
  )
